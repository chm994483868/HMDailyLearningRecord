...
#include "NumberOf1InBinary_1.hpp"

int NumberOf1InBinary_1::numberOf1_Solution1(int n) {
    int count = 0;
    unsigned int flag = 1;
...
int NumberOf1InBinary_1::numberOf1_Solution2(int n) {
    int count = 0;
...
// 测试代码
void NumberOf1InBinary_1::Test(int number, unsigned int expected) {
