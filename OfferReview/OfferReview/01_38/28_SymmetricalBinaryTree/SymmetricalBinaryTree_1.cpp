...
#include "SymmetricalBinaryTree_1.hpp"

bool SymmetricalBinaryTree_1::isSymmetrical(BinaryTreeNode* pRoot1, BinaryTreeNode* pRoot2) {
...
bool SymmetricalBinaryTree_1::isSymmetrical(BinaryTreeNode* pRoot) {
    return isSymmetrical(pRoot, pRoot);
}

// 测试代码
void SymmetricalBinaryTree_1::Test(char* testName, BinaryTreeNode* pRoot, bool expected) {
    if(testName != nullptr)
...
//        6      6
//       5 7    7 5
void SymmetricalBinaryTree_1::Test1() {
...
//        6      9
//       5 7    7 5
void SymmetricalBinaryTree_1::Test2() {
    BinaryTreeNode* pNode8 = CreateBinaryTreeNode(8);
    BinaryTreeNode* pNode61 = CreateBinaryTreeNode(6);
...
//        6      6
//       5 7    7
void SymmetricalBinaryTree_1::Test3() {
    BinaryTreeNode* pNode8 = CreateBinaryTreeNode(8);
    BinaryTreeNode* pNode61 = CreateBinaryTreeNode(6);
    BinaryTreeNode* pNode62 = CreateBinaryTreeNode(6);
    BinaryTreeNode* pNode51 = CreateBinaryTreeNode(5);
...
//        /             \
//       1               1
void SymmetricalBinaryTree_1::Test4() {
...
//        /             \
//       1               1
void SymmetricalBinaryTree_1::Test5() {
    BinaryTreeNode* pNode5 = CreateBinaryTreeNode(5);
    BinaryTreeNode* pNode31 = CreateBinaryTreeNode(3);
    BinaryTreeNode* pNode32 = CreateBinaryTreeNode(3);
    BinaryTreeNode* pNode41 = CreateBinaryTreeNode(4);
...
//                      \
//                       1
void SymmetricalBinaryTree_1::Test6() {
    BinaryTreeNode* pNode5 = CreateBinaryTreeNode(5);
    BinaryTreeNode* pNode31 = CreateBinaryTreeNode(3);
    BinaryTreeNode* pNode32 = CreateBinaryTreeNode(3);
    BinaryTreeNode* pNode41 = CreateBinaryTreeNode(4);
...
// 只有一个结点
void SymmetricalBinaryTree_1::Test7() {
...
// 没有结点
void SymmetricalBinaryTree_1::Test8() {
...
//          /         \
//         5           5
void SymmetricalBinaryTree_1::Test9() {
...
//          /       /
//         5       5
void SymmetricalBinaryTree_1::Test10() {
    BinaryTreeNode* pNode1 = CreateBinaryTreeNode(5);
    BinaryTreeNode* pNode21 = CreateBinaryTreeNode(5);
    BinaryTreeNode* pNode22 = CreateBinaryTreeNode(5);
    BinaryTreeNode* pNode31 = CreateBinaryTreeNode(5);
...
void SymmetricalBinaryTree_1::Test() {
    Test1();
    Test2();
    Test3();
    Test4();
