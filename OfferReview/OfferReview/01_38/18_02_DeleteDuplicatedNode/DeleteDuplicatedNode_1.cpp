...
#include "DeleteDuplicatedNode_1.hpp"

void DeleteDuplicatedNode_1::deleteDuplication(ListNode** pHead) {
...
// 测试代码
void DeleteDuplicatedNode_1::Test(char* testName, ListNode** pHead, int* expectedValues, int expectedLength) {
    if(testName != nullptr)
...
// 某些结点是重复的
void DeleteDuplicatedNode_1::Test1() {
...
// 没有重复的结点
void DeleteDuplicatedNode_1::Test2() {
    ListNode* pNode1 = CreateListNode(1);
    ListNode* pNode2 = CreateListNode(2);
    ListNode* pNode3 = CreateListNode(3);
...
// 除了一个结点之外其他所有结点的值都相同
void DeleteDuplicatedNode_1::Test3() {
    ListNode* pNode1 = CreateListNode(1);
...
// 所有结点的值都相同
void DeleteDuplicatedNode_1::Test4() {
    ListNode* pNode1 = CreateListNode(1);
    ListNode* pNode2 = CreateListNode(1);
    ListNode* pNode3 = CreateListNode(1);
    ListNode* pNode4 = CreateListNode(1);
...
// 所有结点都成对出现
void DeleteDuplicatedNode_1::Test5() {
    ListNode* pNode1 = CreateListNode(1);
    ListNode* pNode2 = CreateListNode(1);
...
// 除了两个结点之外其他结点都成对出现
void DeleteDuplicatedNode_1::Test6() {
    ListNode* pNode1 = CreateListNode(1);
    ListNode* pNode2 = CreateListNode(1);
    ListNode* pNode3 = CreateListNode(2);
    ListNode* pNode4 = CreateListNode(3);
...
// 链表中只有两个不重复的结点
void DeleteDuplicatedNode_1::Test7() {
    ListNode* pNode1 = CreateListNode(1);
    ListNode* pNode2 = CreateListNode(2);
...
// 结点中只有一个结点
void DeleteDuplicatedNode_1::Test8() {
    ListNode* pNode1 = CreateListNode(1);
...
// 结点中只有两个重复的结点
void DeleteDuplicatedNode_1::Test9() {
    ListNode* pNode1 = CreateListNode(1);
    ListNode* pNode2 = CreateListNode(1);
...
// 空链表
void DeleteDuplicatedNode_1::Test10() {
    ListNode* pHead = nullptr;

    Test("Test10", &pHead, nullptr, 0);
}

void DeleteDuplicatedNode_1::Test() {
    Test1();
    Test2();
    Test3();
    Test4();
